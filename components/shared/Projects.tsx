...
export const Projects = () => {
    return (
        <SlideIn direction="left">
            <div className="font-sans" id="projects">
                ...
                <div className="hover:cursor-pointer grid grid-cols-1 gap-8 px-4 py-8 mx-auto max-w-6xl relative min-h-screen">


                    {projectData.map((project, index) => (
                        <div
                            key={index}
                            className="border border-gray-300 rounded-2xl bg-white sticky grid md:grid-cols-1 lg:grid-cols-2 gap-4 shadow-sm hover:shadow-md transition-all duration-300"
                            style={{
